...
class OrganismsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organism" do
    assert_difference('Organism.count') do
      post organisms_url, params: { organism: { species: @organism.species, tax_id: @organism.tax_id, type_of_web: @organism.type_of_web } }
    end
  ...
  test "should update organism" do
    patch organism_url(@organism), params: { organism: { species: @organism.species, tax_id: @organism.tax_id, type_of_web: @organism.type_of_web } }
